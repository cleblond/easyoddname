...
/**
 * Unit tests for the easyoddname question type class.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/easyoddname/questiontype.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_easyoddname_test extends UnitTestCase {
    ...
    public function setUp() {
        $this->qtype = new qtype_easyoddname();
    }
    ...
    public function test_name() {
        $this->assertEqual($this->qtype->name(), 'easyoddname');
    }
